...
@InputType()
class ShoppingCartCreateNestedManyWithoutUsersInput {
...
export { ShoppingCartCreateNestedManyWithoutUsersInput as ShoppingCartCreateNestedManyWithoutUsersInput };
